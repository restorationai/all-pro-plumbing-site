...
priority: 4.8
plan_hash: "d45210b757b6cd27"
generated_at: "2026-07-08T19:31:58.970184+00:00"
manual_override: false
internal_links: ["/blog/", "/services/leak-detection/", "/services/repiping/", "/blog/signs-of-a-slab-leak/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Blog", "url": "/blog/"}, {"name": "Low Water Pressure in Your House? Here Are the Usual Suspects"}]
faq: [{"question": "What is considered normal water pressure for a house?", "answer": "Most plumbing codes and fixture manufacturers target a household supply pressure between 45 and 80 psi, with 55\u201365 psi being the comfortable sweet spot. Below 40 psi and showers feel weak and appliances like dishwashers may not fill properly. Above 80 psi and you start stressing fittings, supply hoses, and water-heater relief valves \u2014 which is why pressure-reducing valves exist."}, {"question": "Can a water softener or filter cause low pressure?", "answer": "Yes, if it's clogged or malfunctioning. Whole-house filters have a sediment cartridge that restricts flow when it's overdue for replacement \u2014 a dirty cartridge can cut pressure noticeably. Water softeners can also cause pressure drop if the resin bed is fouled or the bypass valve is partially engaged. Check your filter's change schedule and make sure any bypass valves are in the correct position."}, {"question": "Why is my water pressure fine in the morning but drops in the afternoon?", "answer": "Time-of-day pressure swings usually point to demand on the municipal main \u2014 when the neighborhood is irrigating lawns or everyone gets home and showers at once, street pressure dips and your house feels it. If the drop is dramatic or getting worse over time, it could also be a partially blocked pipe that handles moderate demand fine but can't keep up at peak flow. A pressure gauge reading taken at different times of day will tell you whether the drop is coming from the street or from inside your system."}, {"question": "My hot water pressure is low but cold pressure is fine \u2014 what does that mean?", "answer": "When low pressure is isolated to the hot side only, the water heater is almost always involved. Scale buildup inside a tank, a partially closed shutoff valve on the cold inlet to the heater, or a failing flex connector on the outlet can all restrict hot-water flow without affecting cold. On tankless heaters, a clogged inlet filter screen is a common culprit. Start by confirming the shutoff valve on the heater's cold-water inlet is fully open, then check for any inline filter the manufacturer specifies."}]
...
1. Turn off every water-using appliance in the house, dishwasher, ice maker, irrigation, everything.
2. Find your water meter (the curb box near the street) and note the reading, or look for the small triangle or dial that spins when water is moving.
3. Wait 15–20 minutes without using any water.
4. Check the meter again. If it moved, water is flowing somewhere it shouldn't be.
