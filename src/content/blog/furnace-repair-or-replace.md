...
priority: 5.4
plan_hash: "6196d9fdbd5d73df"
generated_at: "2026-07-08T19:21:19.343491+00:00"
manual_override: false
internal_links: ["/blog/", "/services/furnace-repair/", "/services/furnace-installation/", "/blog/heat-pump-vs-furnace/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Blog", "url": "/blog/"}, {"name": "Furnace Repair or Replace? The 50% Rule and Other Ways To Decide"}]
faq: [{"question": "Does the 50% rule apply to the cost of parts only, or total repair cost including labor?", "answer": "Total repair cost \u2014 parts and labor combined. Labor is a real expense you're paying regardless of whether you repair or replace, so using parts cost alone would understate what you're actually spending to keep the old unit running. Always get a written estimate that itemizes both before running the calculation."}, {"question": "My furnace is 12 years old and needs a $900 repair. Should I repair or replace?", "answer": "At 12 years, you're in the gray zone where context matters a lot. Run the 50% rule: if a comparable replacement would cost $3,000\u2013$4,500 installed, $900 is 20\u201330% of replacement cost \u2014 generally in repair territory. The more important question is whether this is the first significant repair or part of a pattern. If the unit has been reliable and well-maintained, repair is reasonable. If this is the second or third repair in two years, that pattern is worth weighing alongside the dollar figure."}, {"question": "What's a realistic installed price range for a new gas furnace in California?", "answer": "Installed costs for a residential gas furnace in California typically run $3,000\u2013$6,500 depending on the unit's BTU capacity, efficiency rating (80% vs. 96% AFUE), and whether any ductwork modifications or permit fees are involved. Higher-efficiency condensing furnaces sit at the top of that range but qualify for utility rebates in many California service territories, which can meaningfully offset the upfront cost. Get at least two itemized quotes before deciding."}, {"question": "Can I get a second opinion on a repair estimate before committing?", "answer": "Yes, and for any repair over a few hundred dollars it's worth doing. A second technician may diagnose the same root cause, confirm the repair is appropriate, and give you a different price \u2014 or they may identify a different underlying issue entirely. When getting a second opinion, share as much symptom history as you can (when it started, any sounds or smells, how long the unit has been running poorly) so the technician can do a complete assessment rather than just quoting the part the first company flagged."}]
...
1. Get a written repair estimate from a qualified HVAC technician.
2. Research the installed cost of a comparable replacement furnace (equipment plus labor, not just the unit price on a retailer's website).
3. Divide the repair cost by the replacement cost. If the result is 0.5 or higher, the rule says replace.
