...
priority: 6.0
plan_hash: "851f93048d628b29"
generated_at: "2026-07-08T20:20:00.554551+00:00"
manual_override: false
internal_links: ["/blog/", "/services/emergency-plumbing/", "/services/burst-pipe-repair/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Blog", "url": "/blog/"}, {"name": "Pipe Burst? What To Do in the First 10 Minutes"}]
faq: [{"question": "How do I find my main water shutoff if I've never looked for it before?", "answer": "In most Bakersfield slab-foundation homes, start at the front of the property near the sidewalk \u2014 there's usually a rectangular metal box flush with the ground that contains the water meter and a shutoff. A second shutoff is often located inside the home near the water heater, in the garage, or under the kitchen sink. If you find it now, before an emergency, label it with a piece of tape so anyone in the household can locate it in the dark."}, {"question": "My pipe burst inside the wall and I can't see it \u2014 how do I know how bad the damage is?", "answer": "Press firmly on the drywall around the wet area; if it feels soft or spongy, water has saturated the gypsum core and that section will need to be replaced. Check the floor directly below for soft spots, warping, or discoloration, since water follows framing cavities downward. A plumber or restoration professional can use a non-invasive moisture meter to map exactly how far the water traveled without cutting open every wall."}, {"question": "Will my homeowner's insurance cover a burst pipe?", "answer": "Most standard homeowner's policies cover sudden and accidental water damage from a burst pipe, including the cost of tearing out and replacing damaged materials \u2014 but not the pipe repair itself, which is typically considered a maintenance item. Coverage is often disputed when an adjuster determines the pipe failed slowly over time rather than suddenly, which is one reason documenting the discovery time and calling your insurer promptly matters. Review your specific policy's water damage exclusions, particularly around slab leaks and gradual leaks, before assuming coverage."}, {"question": "Can I use the water in my house at all after I shut off the main?", "answer": "No \u2014 once the main is off, the supply lines are depressurized and no water will flow to faucets, toilets, or appliances. If you need water while waiting for the repair, fill a few large containers or pitchers before you shut off the main. Keep in mind that toilets can be flushed once using water already in the tank, but the tank won't refill until the main is restored."}]
...
Once you've turned it off, open a faucet on the lowest floor of the house. This bleeds pressure out of the lines and slows the drip from the damaged section significantly.

## Step Two: Get the Electricity Safe

Water and electricity are the combination that turns a plumbing emergency into a life-safety emergency. If water is pooling near an outlet, running down a wall with electrical switches, or dripping anywhere near your electrical panel, go to the breaker box and shut off the circuits for the affected area before you walk through standing water.
...
Only after you've documented should you start moving furniture off wet carpet, pulling soaked rugs outside, and running fans.
...
- Whether you've shut the main off
- Whether there's visible water damage to walls, ceilings, or flooring
- Whether the water heater or HVAC system is in the affected area
...
Stopping the water is the beginning, not the end. Here's what the next 24–72 hours typically look like:
