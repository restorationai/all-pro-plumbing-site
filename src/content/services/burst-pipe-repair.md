...
priority: 8.1
plan_hash: "db583fc75793ae28"
generated_at: "2026-07-08T19:00:41.092935+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/delano-ca/burst-pipe-repair/", "/service-areas/oildale-ca/burst-pipe-repair/", "/service-areas/rosedale-ca/burst-pipe-repair/", "/service-areas/shafter-ca/burst-pipe-repair/", "/service-areas/taft-ca/burst-pipe-repair/", "/service-areas/tehachapi-ca/burst-pipe-repair/", "/blog/what-to-do-burst-pipe/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Burst and Leaking Pipe Repair"}]
faq: [{"question": "My water bill spiked but I can't find any visible leak \u2014 how do you locate a hidden pipe leak?", "answer": "We start with a pressure test on the supply system: shut all fixtures, attach a gauge to a hose bib, and watch whether the line holds pressure over several minutes. A drop confirms an active leak somewhere on the pressurized side. From there we use acoustic listening equipment to narrow the location \u2014 particularly useful for slab leaks, where the sound of water escaping under concrete carries through the foundation. In most cases we can isolate the leak to within a foot or two before opening anything."}, {"question": "What's the difference between repairing a burst pipe and rerouting it, and how do I know which one I need?", "answer": "A repair cuts out the failed section and splices in new material at the same location. A reroute abandons the damaged run entirely and installs a new line along a different path \u2014 typically through walls or attic space instead of under the slab. Reroutes make sense when the pipe is in a location that's extremely difficult or expensive to access (deep slab, post-tension concrete), when the same line has failed more than once, or when adjacent pipe condition suggests the repair won't last. We'll give you a straight assessment of which approach fits your situation after we've seen the pipe."}, {"question": "The pipe burst inside a wall \u2014 do I need a plumber or a contractor first?", "answer": "The plumber comes first. Until the broken pipe is repaired and the water is off, there's nothing for a contractor to rebuild \u2014 and any drywall or flooring work done before the pipe is fixed will just get wet again. Once the repair is complete and pressure-tested, you can bring in a drywall contractor for the access opening. If the water spread significantly into walls or flooring, a water damage restoration professional should assess moisture levels before drywall goes back up, since closing wet cavities leads to mold growth."}, {"question": "A pipe froze overnight and now I have low water pressure \u2014 is it already burst, or could it just be a blockage?", "answer": "It could be either, and you won't know until the pipe finishes thawing. A frozen pipe that's still intact will often restore normal pressure as the ice clears. A pipe that cracked or split during the freeze may hold pressure while still partially frozen, then fail completely once it thaws \u2014 which is why low pressure after a freeze deserves attention even if you're not seeing water yet. If pressure doesn't return to normal within an hour of the house warming up, or if you hear water running inside a wall, shut the main and call us."}, {"question": "How do I document a burst pipe for a homeowner's insurance claim?", "answer": "Photograph the damage before any cleanup or repair \u2014 the wet area, the access point into the wall or slab, and the failed section of pipe itself once it's exposed. Note the date and time you discovered the leak and when you shut the water off. Keep any sections of pipe the plumber removes, as adjusters sometimes want to inspect the cause of failure. Your insurer will also want the plumber's invoice showing what was repaired and why. We can provide a written description of the failure mode if your adjuster requests it."}]
...
**5. Document and walk you through what was found.**
We show you what failed, why it likely failed, and whether adjacent pipe looks like it's approaching the same condition. That information matters for insurance claims and for deciding whether a targeted repair or a broader repipe makes more sense.
...
For insurance documentation, photos of the pipe failure, the access point, and the surrounding material condition taken before and after repair are essential. Adjusters want to see the cause of loss, not just the finished patch.
