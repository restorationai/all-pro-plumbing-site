...
export default {
  ...
  theme: {
    extend: {
      colors: {
        /* Angie 2026-09-13: "red white and blue (no black)" — the dark
           ramp is retinted to navy blue-black (slate scale) so every dark
           surface and heading reads BLUE, never neutral black. */
        dark: {
          DEFAULT: "#0f172a",
          50: "#f8fafc",
          100: "#f1f5f9",
